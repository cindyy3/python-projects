...
at_content = float(at_count) / total_count * 100
sum_counts = float(a_count + t_count + g_count + c_count)
...
print 'Sum of A+T+G+C counts:', sum_counts
print 'Total count:', total_count
print 'Length of nucleotides:', nucleotides_length
